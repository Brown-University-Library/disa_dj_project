...
# export DISA_DJ__STATIC_ROOT="/static/"  # normally what I always use
# export DISA_DJ__STATIC_ROOT="static/"  # trying this to address STATIC_FILE_FINDERS error
export DISA_DJ__STATIC_ROOT="disa_app/static/"  # trying this to see if collectstatic works
